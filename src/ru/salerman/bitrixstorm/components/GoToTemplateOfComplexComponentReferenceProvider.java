...
public class GoToTemplateOfComplexComponentReferenceProvider extends PsiReferenceProvider {
    @NotNull
    @Override
    public PsiReference[] getReferencesByElement(@NotNull PsiElement psiElement, @NotNull ProcessingContext processingContext) {
        ...
        GoToTemplateOfComplexComponentReference psiReference = new GoToTemplateOfComplexComponentReference(psiElement, psiElement.getProject());
